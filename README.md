...
### Steps to run the Javelin App on local
-- Download or pull the Javelin app from git on local

-- Open your 'javelin app' folder in terminal and run the below commands:

-- Run 'npm install' to install all important packages.

-- Run 'npm run dev' to run the app on local
